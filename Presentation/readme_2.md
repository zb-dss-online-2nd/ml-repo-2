...
<img width="50%" height="50%" alt="image" src="https://user-images.githubusercontent.com/104780664/174302122-c582c859-210a-475a-b64a-cad1d4c1b8f3.png"> 
<img width="50%" height="50%" alt="image" src="https://user-images.githubusercontent.com/104780664/174301819-cac45831-dd74-4027-833f-a838b9944d12.png">
...
----------
## :exclamation: 5. 결론 및 한계, 보완 방법
### (1) 결론
- 롯데, 한화를 제외한 8개 구단이 포스트 시즌 진출 가능할 것으로 예측됨.
- 아직 시즌 중이므로 정확한 1위 예측은 힘들 것으로 보임.
- 추가적으로 예측 비율로 우승을 예측해봤을때 유의미한 값을 찾기엔 부족함.

### (2) 한계 및 보안 방법
- 데이터량 부족이 예측 어려움에 원인 중 하나로 예상되며, 데이터가 누적될 수록 우승팀 예측 확률이 높아질 것으로 생각됨.
- 상대 승률, 포스트 시즌 대진표 등 중요 변수 고려하지않음. -> 상대 승률 등은 우승 후보를 추린 뒤 적용 가능한 것으로 보임
- 실시간 데이터 누적을 통한 데이터 수집이 아닌 것이 예측을 어렵게 만듦.
- 이미 발생한 승차 고려하지 않은 점 -> 승차 등의 문제는 새로운 변수로 설정해서 해결할 수 있을듯 - 연구 필요
