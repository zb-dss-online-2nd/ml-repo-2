...
3. [변수 설정 및 데이터 수집](#3.-변수-설정-및-데이터-수집)
    (1) [데이터 수집 방법](#(1)-데이터-수집-방법)
    (2) [변수 설명](#(2)-변수-설명)
    (3) [Label_Grade](#(3)-Label_Grade)
    (4) [Corrleaion and heatmap](#(4)-Corrleaion-and-heatmap)
    (5) [Pairplot](#(5)-Pairplot)
    (6) [Boxplot](#(6)-Boxplot)
    (7) [팀별 월 평균 승률 비교](#(7)-팀별-월-평균-승률-비교)
4. [모델 선정 및 분석 기법](#4.-모델-선정-및-분석-기법)
    (1) 모델 선정 기준(#(1)-모델-선정-기준)
    (2) 사용한 분석기법(#(2)-사용한-분석기법)
5. [결론 및 한계, 보완 방법](#5.-결론-및-한계,-보완-방법)
    (1) [결론](#(1)-결론)
    (2) [한계 및 보안 방법](#(2)-한계-및-보안-방법)
6. [참고 자료](#6.-참고-자료)
